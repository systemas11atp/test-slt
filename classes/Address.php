...
class AddressCore extends ObjectModel
{
    ...
    {
        capuraLogs::nuevo_log("Address add id : {$this->id}");
        capuraLogs::nuevo_log("Address add id_customer : {$this->id_customer}");
        ...
        $myStore = $_SERVER['HTTP_HOST'];
        
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://prod-100.westus.logic.azure.com:443/workflows/7ca8e19f1aa94c5ab7a6089583dcf209/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=Qvu8PoDXL9nBd_iQ7Jf85uRu-24YOkL45B4RLCFa3zY",
            ...
            CURLOPT_POSTFIELDS => "{\"n_cid\": \"$this->id\", \"url\":\"{$myStore}\"}",
    ...
    public function update($null_values = false)
    {
        ...
        $POSTFIELDS = "{\"id_address\":\"$this->id\",\"customerID\" : \"$customerID\",\"addressID\" : \"$addressID\",\"effective\" : \"$effective\", \"accion\": \"actualizar\", \"url\": \"{$myStore}\"}";
    ...
    public function delete()
    {
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://prod-56.westus.logic.azure.com:443/workflows/f65aedeefaa54a9690ac5938504267b1/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=I4W5b2CCqpE_G_c4zzZM69fQGJUvUHdoMXfnv4amy8g",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
            CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
            CURLOPT_CUSTOMREQUEST => "POST",
            CURLOPT_POSTFIELDS => "{\"id_address\" : \"$this->id\",\"customerID\" : \"$customerID\",\"addressID\" : \"$addressID\",\"effective\" : \"$effective\", \"accion\": \"eliminar\", \"url\": \"{$myStore}\"}",
            CURLOPT_HTTPHEADER => array("content-type: application/json"),
        ));
        $responseP = curl_exec($curl);
        $err = curl_error($curl);
