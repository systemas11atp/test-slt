...
<div class="linia_tytul">
  <div class="tytuly">{l s='On sale' d='Modules.Specials.Shop'}</div></div>
  <div class="products">		
  ...
  <a class="all-product-link pull-xs-left pull-md-right h4" href="{$allSpecialProductsLink}">{l s='All products' d='Shop.Theme.Catalog'}
