        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="cart-content">
              ...
              {/if}
              <p><strong>{l s='Total:' d='Shop.Theme.Checkout'}</strong>&nbsp;<label style="font-size: 16px;" id="modal-totalConIva"></label>&nbsp;{$cart.labels.tax_short}</p>
              <script>
                sumarTotal('{$cart.totals.total.value}', '{$cart.subtotals.tax.value}', 'modal-totalConIva')
              </script>
